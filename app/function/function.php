...
function changeTitle($str, $strSymbol = '-', $case = MB_CASE_LOWER)
{
	...
	$str = str_replace(['"', "'"], '', $str);
	$str = stripUnicode($str); // Loại bỏ dấu tiếng Việt
...
function stripUnicode($str)
{
	...
	foreach ($unicode as $khongDau => $coDau) {
		$arr = explode("|", $coDau); // Tách các ký tự có dấu thành mảng
		$str = str_replace($arr, $khongDau, $str); // Thay thế các ký tự có dấu bằng không dấu
	}
