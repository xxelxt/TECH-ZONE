			...
			<div class="wrap-login100">
                ...
                @if(count($errors) > 0)
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="firstname" placeholder="@lang('lang.fristname')" required>
                    ...
                    <div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="lastname" placeholder="@lang('lang.lastname')"required>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
                    ...
                    <div class="wrap-input100 validate-input" >
						<input class="input100" type="password" name="passwordagain" placeholder="@lang('lang.password_again')"required>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock" aria-hidden="true"></i>
						</span>
					...
					<div class="text-center p-t-136">
						...
						@lang('lang.login') @lang('lang.account')
