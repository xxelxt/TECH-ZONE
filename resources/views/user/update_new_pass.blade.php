...
<style>
    ...
    .register-button {
        ...
        /* Màu xám nhạt hoặc màu tùy chọn */
        color: #333;
        padding: 15px 20px;
        border: none;
        border-radius: 4px;
        cursor: pointer;
        width: 100%;
        /* Hoặc điều chỉnh độ rộng tùy thích */
        margin-top: 10px;
        /* Khoảng cách giữa nút đăng nhập và nút đăng ký */
        transition: all 0.5s;
    }
...
@section('content')
    ...
    <div class="login-container">
        <form action="/solve-update-new-pass" method="POST" class="login-form">
            ...
            <div class="form-group">
                <input type="password" name="newpass_confirmation" class="form-control" placeholder="@lang('lang.confirm_newpass')" required>
            </div>
            <div class="form-group">
