            ...
            <div class="col-md-11">
                ...
                <div class="d-flex flex-column">
                    <div>
                        ...
                        <img id="currentImage" src="user_asset/images/banners/{!! $banners['image'] !!}" width="700px" alt="">
                        <br>
                    </div>
                    <div class="ms-3" id="previewContainer">
                        <span class="text-muted" style="display: none;" id="newImageLabel"><br></span>
                        <img id="imagePreview" src="#" alt="Image Preview" style="display: none; width: 700px; margin-top: 10px;">
                    </div>
                </div>
            </div>
        </div>
